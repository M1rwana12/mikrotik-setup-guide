...
[![Мова](https://img.shields.io/badge/Мова-Українська-FFD700?style=for-the-badge&logo=ukraine)](README.ua.md)
...
<h2 style="margin: 15px 0 5px; font-size: 28px; text-shadow: 0 2px 5px rgba(0,0,0,0.5);">Автор: @M1rwana12</h2>
...
<p style="margin: 8px 0 0; font-size: 15px;"><strong>Оновлено:</strong> 10 листопада 2025, 16:31 EET (UA)</p>
<p style="margin: 8px 0 0; font-size: 15px;"><strong>Пристрої:</strong> CCR1036, RB760iGS, hEX, RB4011</p>
...
> Від підключення до провайдера → до **жорсткого фаєрволу + BlackIP захисту**  
...
![Топологія мережі — CCR + RB760iGS + Failover + BlackIP](diagrams/topology-failover.drawio.png)

> **Оновлено 10.11.2025**  
> - **CCR1036**: Failover, NAT, Firewall, Scheduler  
> - **RB760iGS**: PoE, SFP, VLAN, Graphing  
> - **BlackIPforFirewall**: ~45k IP (malware/spam) → `raw drop`  
> - **Failover**: 2 провайдери (основний + резерв)  
>  
...
| **Блок поганих IP (malware, spam, botnets)** | `scripts/07-blackip.rsc` |
...
<h2 style="margin: 0; font-size: 30px; text-shadow: 0 3px 6px rgba(0,0,0,0.5);">Твій гайд — №1 в Україні 2025</h2>
<p style="margin: 15px 0 0; font-size: 18px;"><strong>Готовий до розгортання на CCR, RB760iGS та будь-якому сучасному MikroTik.</strong></p>

**Зірочка (star) — мотивація для оновлень!**  
**Питання? Пишіть у [Issues](https://github.com/M1rwana12/mikrotik-setup-guide/issues) або Telegram: <a href="https://t.me/imSenya" style="color: #FFD700;">@imSenya</a>**
